...
class KPI(object):
    ...
    def total_memory(self):
        return self.weights_memory + self.activation_memory

    def __repr__(self):
        return f"Weights_memory: {self.weights_memory}, Activation_memory: {self.activation_memory}"
