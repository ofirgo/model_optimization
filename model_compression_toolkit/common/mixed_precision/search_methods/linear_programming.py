...
def _formalize_problem(layer_to_indicator_vars_mapping: Dict[int, Dict[int, LpVariable]],
    ...
    # TODO: should we split to weights consumption and activation consumption or just look at the total memory size?
    #  if only one is inf then we might have a problem (or one much larger than the other)
